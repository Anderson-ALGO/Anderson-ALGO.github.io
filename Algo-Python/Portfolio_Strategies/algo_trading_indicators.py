...
for symbol in tickers:
    ...
    print("These statistics are from "+str(start) +
          " up till now with "+str(numGains+numLosses)+" trades:")
    print("Total return over "+str(numGains+numLosses) +
          " trades: " + str(totReturn)+"%")
